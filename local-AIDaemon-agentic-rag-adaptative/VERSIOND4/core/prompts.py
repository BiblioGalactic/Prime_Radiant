...
"""
    ...
    def _direct_prompt(cls, query: str, context: str = "") -> str:
        """Prompt directo con instrucciones claras para evitar respuestas genéricas"""
        if context:
...
INSTRUCCIONES: Responde directamente a la PREGUNTA usando la información proporcionada. NO te presentes ni expliques qué puedes hacer. Ve directo al tema de la pregunta.

RESPUESTA:"""
        return f"""PREGUNTA: {query}

INSTRUCCIONES: Responde directamente a la pregunta. NO te presentes ni expliques qué puedes hacer.
