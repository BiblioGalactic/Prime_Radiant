...
class Orchestrator:
    ...
    def process_query_adaptive(
        ...
        # 4. CRÍTICA Y MEJORA - DESACTIVADO (complica respuestas)
        # El modelo debe responder directamente sin post-procesamiento
        pass
...
RESPUESTA FINAL:"""
    ...
    def interactive_mode(self):
        """Modo interactivo con CLASIFICACIÓN DE INTENCIONES"""
        print("=" * 60)
        print("   🤖 WIKIRAG v2.3.1 - Sistema de IA Autónomo")
